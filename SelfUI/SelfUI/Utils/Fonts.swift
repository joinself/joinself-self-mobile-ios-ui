...
extension Font {
    ...
    static let heading1: Font = Font.custom("Barlow-Bold", size: 64)
    static let heading2: Font = Font.custom("Barlow-Bold", size: 51)
    static let heading3: Font = Font.custom("Barlow-Bold", size: 36)
